...
const PhoneInput = dynamic(() => import('react-phone-input-2'), {
  ssr: false,
  loading: () => <input placeholder="Phone" disabled style={{ height: '38px', width: '100%', borderRadius: '4px', border: '1px solid #ccc', padding: '0 12px' }} />,
});

/* ── Inline SVG icons (replaces lucide-react) ── */
const MapPin = (props: any) => (
  <svg viewBox="0 0 24 24" width={props.size || 15} height={props.size || 15} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className={props.className}>
...
const Send = (props: any) => (
  <svg viewBox="0 0 24 24" width={props.size || 13} height={props.size || 13} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
const ChevronRight = (props: any) => (
  <svg viewBox="0 0 24 24" width={props.size || 12} height={props.size || 12} stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className={props.className}>
...
export default function Footer() {
  ...
  const { countryCode: detectedCountry } = useGeo();
