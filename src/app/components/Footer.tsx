...
const footerData = {
  ...
  rangeCol1: [
    ...
    { label: "Cashew whole (Small)", href: "#" },
    { label: "Cashew 2 Piece", href: "#" },
    { label: "Raw Maize", href: "#" },
    { label: "Brown Raisins", href: "#" },
    { label: "4 Suta Round Makhana Flake", href: "#" },
    { label: "White Plain Makhana Flake", href: "#" },
    { label: "Cashew whole (Medium)", href: "#" },
  ],
  rangeCol2: [
    { label: "Cashew 4 Piece", href: "#" },
    { label: "White Maize", href: "#" },
    { label: "Seedless Raisins", href: "#" },
    { label: "16.5mm Makhana Flake", href: "#" },
    { label: "12.7mm Plain Makhana Flake", href: "#" },
    { label: "Makhana Flake", href: "#" },
    { label: "Cashew Broken", href: "#" },
    { label: "Cashew 8 Piece", href: "#" },
    { label: "Yellow Corn", href: "#" },
  ],
  legal: [
