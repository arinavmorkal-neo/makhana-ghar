        ...
        <div className={styles.topBar}>
          <div className={styles.topBarInner}>
            ...
            <div className={styles.topContacts}>
              <a href="tel:+918002661555" className={styles.topContact}>
              ...
              <a href="mailto:makhanagha.marketing@gmail.com" className={styles.topContact}>
                <span className={styles.contactIcon}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                makhanagha.marketing@gmail.com
              </a>
            </div>
            ...
            <div className={styles.topSocials}>
              {[
                ...
                { label: 'Instagram', href: 'https://www.instagram.com/makhanaghar/', path: 'M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4C22 19.4 19.4 22 16.2 22H7.8C4.6 22 2 19.4 2 16.2V7.8C2 4.6 4.6 2 7.8 2z' },
                { label: 'Twitter', href: 'https://x.com/makhanaghar', path: 'M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z' },
                { label: 'LinkedIn', href: 'https://www.linkedin.com/in/makhana-ghar-a155ba41a', path: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z' },
              ].map(({ label, href, path }) => (
